...
--
-- Table structure for table `enderecodocliente`
--

DROP TABLE IF EXISTS `enderecodocliente`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `enderecodocliente` (
  `cpfClienteEnderecoCliente` int NOT NULL,
  `idLocalEnderecoCliente` int NOT NULL,
  PRIMARY KEY (`cpfClienteEnderecoCliente`),
  KEY `idCliente_idx` (`cpfClienteEnderecoCliente`),
...
--
-- Dumping data for table `enderecodocliente`
--

LOCK TABLES `enderecodocliente` WRITE;
/*!40000 ALTER TABLE `enderecodocliente` DISABLE KEYS */;
/*!40000 ALTER TABLE `enderecodocliente` ENABLE KEYS */;
UNLOCK TABLES;
