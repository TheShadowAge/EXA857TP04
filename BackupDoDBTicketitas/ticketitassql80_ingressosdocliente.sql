...
--
-- Table structure for table `ingressosdocliente`
--

DROP TABLE IF EXISTS `ingressosdocliente`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ingressosdocliente` (
  `idIngressoIngressosCliente` int NOT NULL,
  `cpfClienteIngressosCliente` int NOT NULL,
  PRIMARY KEY (`idIngressoIngressosCliente`),
...
--
-- Dumping data for table `ingressosdocliente`
--

LOCK TABLES `ingressosdocliente` WRITE;
/*!40000 ALTER TABLE `ingressosdocliente` DISABLE KEYS */;
/*!40000 ALTER TABLE `ingressosdocliente` ENABLE KEYS */;
UNLOCK TABLES;
